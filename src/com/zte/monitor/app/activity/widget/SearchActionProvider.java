...
import com.zte.monitor.app.activity.SearchBaseInfoActivity;
import com.zte.monitor.app.activity.SearchSmsActivity;
import com.zte.monitor.app.activity.SearchSpcInfoActivity;
import com.zte.monitor.app.activity.SearchUserActivity;
...
public class SearchActionProvider extends ActionProvider {
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        subMenu.add(0, 1, 1, "短信搜索").setIcon(R.drawable.message).setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem menuItem) {
