 ...
 */
public class SearchSmsFromDBActivity extends BaseActivity implements View.OnClickListener {

    private EditText imsiEditText;
    private Spinner smsTypeSpinner;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_sms_from_db);
    ...
    private void initViews() {
        ...
        smsTypeSpinner = (Spinner) findViewById(R.id.search_sms_type);
        ...
        dateFromEditText.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                if (motionEvent.getAction() == MotionEvent.ACTION_DOWN) {
                    DatePickerDialog dpd = new DatePickerDialog(SearchSmsFromDBActivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
    ...
    private void fillSpinner() {
        ...
        smsTypeSpinner.setAdapter(smsCenterAdapter);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.search_button:
                Intent intent = new Intent(SearchSmsFromDBActivity.this, SmsListFromDBActivity.class);
                intent.putExtra("IMSI", imsiEditText.getText().toString());
                intent.putExtra("SmsType", ((KeyValuePair) smsTypeSpinner.getSelectedItem()).key);
